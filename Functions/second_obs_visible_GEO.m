function [vis, RA_error, Dec_error] = second_obs_visible_GEO(r0_truth, v0_truth, r0_IOD, v0_IOD, T_truth, T_error, T_IOD, r_site, r_site_times, JD0)

if isnan(T_IOD) || ~isreal(T_IOD)
    vis = 0;
    return
end
