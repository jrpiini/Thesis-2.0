...
function [chromosomes, Elite] = GA_IOD_lambert_GTO(Observation, Lambert_Type, use_3_pts, ACO)
rng("shuffle")
tic
...
rho0_max = 60000; % default value, max observable slant range for LEO (alt <= 2000), see max_slant_range.m
