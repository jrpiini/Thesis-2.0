function [V1, V2] = lambert_curtis_UV(R1, R2, t)
% 
%{
...
% 
%{
This function evaluates the Stumpff function stumpC(z) according
to Equation 3.53.
z - input argument
c - value of stumpC(z)
...
% 
%{
This function evaluates the Stumpff function stumpS(z) according
to Equation 3.52.
z - input argument
s - value of stumpS(z)
User M-functions required: none
